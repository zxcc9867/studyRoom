...
`새 글 확인`을 누르면 즉시 수집을 요청하고 완료 뒤 목록을 갱신합니다. 실행 중 작업은 공유하고 계정·주제·출처별5분 제한을 적용하며 정기 수집은1시간 기준을 유지합니다. 한 번에 관심 주제1개와 수집 가능한 RSS/API 최대4곳을 기존 무료 한도 내에서 확인합니다. 매번 새 글이 있거나 AI 요약이 바로 완성된다고 보장하지 않습니다.
