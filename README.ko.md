...
**이번 변경은 운영에 배포·활성화하지 않았습니다.** 운영 DB·서버 함수·웹 배포와 이용 조건 승인·Cron 활성화는 별도 출시 작업입니다. [요구사항](memory-bank/prd-tech-feed.md) · [출시 안내](docs/tech-feed/release.md) · [커리어 코드 복원](archive/career-coach/README.md). 커리어 전용 화면·자동 실행은 보관하며 시간대 설정과 공부 재시작 코칭은 유지합니다.
