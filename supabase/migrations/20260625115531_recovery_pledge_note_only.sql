-- recovery_pledge_note_only
--
-- Keep tomorrow's recovery pledge as a recovery-request note, not as a dated
-- study_todos row. The makeup task remains the only todo created on submit.
