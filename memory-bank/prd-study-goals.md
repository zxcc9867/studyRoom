...
- 사용자가 목표명, 목표 날짜, 목표 공부 시간을 설정할 수 있다.
...
2. `새 목표`를 눌러 목표명, 목표 날짜, 목표 공부 시간을 입력한다.
...
- 목표 공부 시간은 선택값이며 0시간도 허용한다.
- 연결된 todo가 없으면 공부 시간 기준으로만 진행률을 계산한다.
...
- [x] 목표 카드는 D-day, 진행률, 연결 todo 수, 공부 시간을 표시한다.
